...
2. Сделать скрипт исполняемым **_(Возможно упадет. Так как в программе используется sys.argv[1], что подходит с первым вариантом запуска. В данном случае надо будет использовать sys.argv[0])_**
